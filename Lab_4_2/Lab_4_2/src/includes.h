...
#define GPIO_PORT1_GPER (*((volatile uint32 t*)(GPIO_PORT1_ADDRESS + GPIO_GPER_OFFSET)))
#define GPIO_PORT1_ODER (*((volatile uint32 t*)(GPIO_PORT1_ADDRESS + GPIO_ODER_OFFSET)))
#define GPIO_PORT1_OVR (*((volatile uint32 t*)(GPIO_PORT1_ADDRESS + GPIO_OVRC_OFFSET)))
